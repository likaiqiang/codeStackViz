import { tokenIsIdentifier, tokenIsKeyword, tokenIsKeywordOrIdentifier, tokenIsLiteralPropertyName, tokenLabelName, tt, tokenIsFlowInterfaceOrTypeOrOpaque } from "../../tokenizer/types.js";
import { types as tc } from "../../tokenizer/context.js";
import { isIteratorStart } from "../../util/identifier.js";
import FlowScopeHandler from "./scope.js";
import { BIND_LEXICAL, BIND_VAR, BIND_FUNCTION, BIND_FLOW_DECLARE_FN, SCOPE_ARROW, SCOPE_FUNCTION, SCOPE_OTHER } from "../../util/scopeflags.js";
